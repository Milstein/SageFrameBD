...
$(function () {
    ...
    function getTourContent(tourContentID) {
        ...
        else if (tourIdList == 9 || tourIdList == 11) {
            $(".tourMsg").animate({
    ...
    // Message to Display for Each Content to Tour
     tourMessageList = new Array(
                            "<span class='sfTrHeading'>Welcome to SageFrame tour.</span>This is the Top Sticky Bar which contains the SageFrame logo and its version description. Along with that you can access the UI (User Interface) setting, Preview and User Profile.",
